...
with open ('file_encode.txt', 'w') as data:
    ...
    data.write(with open('file_encode.txt', 'w') as data:
...
print('До сжатия: \t' + decoded_string)
print('После сжатия: \t' + rle_encode(decoded_string))
print(f'Кофициент сжатия: \t{round(len(decoded_string) / len(encoded_string), 1)}'))
